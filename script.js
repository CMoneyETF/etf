...
const ETFDividendTool = () => {
  ...
  return (
    <div className="p-4 max-w-full mx-auto">
      <h1 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6">2024 ETF 配息年表查詢工具</h1>
      
      <div className="mb-4 sm:mb-6">
        <div className="mb-4">
          <label htmlFor="search" className="block text-sm font-medium text-gray-700 mb-2">搜尋 ETF</label>
          <input
            id="search"
            type="text"
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium text-gray-700 mb-2">配息週期篩選</label>
      ...
      <div className="overflow-x-auto">
        <table className="w-full bg-white shadow-md rounded text-sm sm:text-base">
          <thead className="bg-gray-100">
            <tr>
              <th className="px-2 py-2 sm:px-4 sm:py-2">代號</th>
              <th className="px-2 py-2 sm:px-4 sm:py-2">名稱</th>
              <th className="px-2 py-2 sm:px-4 sm:py-2">配息週期</th>
              <th className="px-2 py-2 sm:px-4 sm:py-2">今年配息</th>
              <th className="px-2 py-2 sm:px-4 sm:py-2">相較去年</th>
              <th className="px-2 py-2 sm:px-4 sm:py-2">年化殖利率</th>
              <th className="px-2 py-2 sm:px-4 sm:py-2">類別</th>
            </tr>
          </thead>
          <tbody>
            {filteredETFs.map(etf => (
              <tr key={etf.code} className="border-b">
                <td className="px-2 py-2 sm:px-4 sm:py-2">{etf.code}</td>
                <td className="px-2 py-2 sm:px-4 sm:py-2">{etf.name}</td>
                <td className="px-2 py-2 sm:px-4 sm:py-2">{etf.period}</td>
                <td className="px-2 py-2 sm:px-4 sm:py-2">{etf.dividend}</td>
                <td className={`px-2 py-2 sm:px-4 sm:py-2 ${getComparedColor(etf.compared)}`}>{etf.compared}</td>
                <td className="px-2 py-2 sm:px-4 sm:py-2">{etf.yield}</td>
                <td className="px-2 py-2 sm:px-4 sm:py-2">{etf.category}</td>
              </tr>
            ))}
          </tbody>
        </table>
...
ReactDOM.render(<ETFDividendTool />, document.getElementById('root'));
