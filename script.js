...
React.createElement("a", {
  ...
  className: "floating-banner" }, /*#__PURE__*/

React.createElement("img", { src: "https://i.imgur.com/e8PGBTr.png", alt: "ETF Choice Banner" }));
...
const ETFDividendTool = () => {
  ...
  return /*#__PURE__*/(
    React.createElement("div", { className: "p-4 max-w-full mx-auto" }, /*#__PURE__*/
    React.createElement("h1", { className: "text-xl sm:text-2xl font-bold mb-4 sm:mb-6 " }, "2024 ETF \u914D\u606F\u5E74\u8868\u67E5\u8A62\u5DE5\u5177"), /*#__PURE__*/

    React.createElement("div", { className: "mb-4 sm:mb-6" }, /*#__PURE__*/
    React.createElement("div", { className: "mb-4 flex " }, /*#__PURE__*/
    React.createElement("input", {
      ...
      className: "w-full max-w-md p-2 border rounded shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" })), /*#__PURE__*/
    ...
    React.createElement("table", { className: "w-full bg-white shadow-md rounded text-base sm:text-lg" }, /*#__PURE__*/
    React.createElement("thead", { className: "bg-gray-100" }, /*#__PURE__*/
    React.createElement("tr", null, /*#__PURE__*/
    React.createElement("th", { onClick: () => requestSort('code'), className: "px-2 py-2 sm:px-4 sm:py-3 text-center cursor-pointer" }, "\u4EE3\u865F ", getSortDirection('code')), /*#__PURE__*/
    React.createElement("th", { onClick: () => requestSort('name'), className: "px-2 py-2 sm:px-4 sm:py-3 text-center cursor-pointer" }, "\u540D\u7A31 ", getSortDirection('name')), /*#__PURE__*/
    React.createElement("th", { onClick: () => requestSort('period'), className: "px-2 py-2 sm:px-4 sm:py-3 text-center cursor-pointer" }, "\u914D\u606F\u9031\u671F ", getSortDirection('period')), /*#__PURE__*/
    React.createElement("th", { onClick: () => requestSort('dividend'), className: "px-2 py-2 sm:px-4 sm:py-3 text-center cursor-pointer" }, "\u4ECA\u5E74\u914D\u606F ", getSortDirection('dividend')), /*#__PURE__*/
    React.createElement("th", { onClick: () => requestSort('compared'), className: "px-2 py-2 sm:px-4 sm:py-3 text-center cursor-pointer" }, "\u76F8\u8F03\u53BB\u5E74 ", getSortDirection('compared')), /*#__PURE__*/
    React.createElement("th", { onClick: () => requestSort('yield'), className: "px-2 py-2 sm:px-4 sm:py-3 text-center cursor-pointer" }, "\u5E74\u5316\u6B96\u5229\u7387 ", getSortDirection('yield')), /*#__PURE__*/
    React.createElement("th", { onClick: () => requestSort('category'), className: "px-2 py-2 sm:px-4 sm:py-3 text-center cursor-pointer" }, "\u985E\u5225 ", getSortDirection('category')))), /*#__PURE__*/


    React.createElement("tbody", null,
    sortedETFs.map((etf) => /*#__PURE__*/
    React.createElement("tr", { key: etf.code, className: "border-b" }, /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-3 text-center" }, etf.code), /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-3 text-center" }, etf.name), /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-3 text-center" }, etf.period), /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-3 text-center" }, etf.dividend), /*#__PURE__*/
    React.createElement("td", { className: `px-2 py-2 sm:px-4 sm:py-3 text-center ${getComparedColor(etf.compared)}` }, etf.compared), /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-3 text-center" }, etf.yield), /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-3 text-center" }, etf.category)))))), /*#__PURE__*/
    ...
    React.createElement("div", { className: "mt-4 text-center text-gray-600 text-sm" }, "\u672C\u5DE5\u5177\u7531 ETF\u5B58\u80A1\u8A08\u5283\u5C0F\u7DE8 \u88FD\u4F5C"), /*#__PURE__*/
