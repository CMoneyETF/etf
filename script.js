...
const ETFDividendTool = () => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement("label", { htmlFor: "search", className: "block text-sm font-medium text-gray-700 mb-2" }, "\u641C\u5C0B ETF"), /*#__PURE__*/
    React.createElement("input", {
      ...
      className: "w-full p-2 border rounded shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" })), /*#__PURE__*/
    ...
    React.createElement("button", {
      ...
      className: `px-2 py-1 text-sm sm:px-3 sm:py-1 rounded transition duration-300 ${
    ...
    React.createElement("table", { className: "w-full bg-white shadow-md rounded text-sm sm:text-base" }, /*#__PURE__*/
    React.createElement("thead", { className: "bg-gray-100" }, /*#__PURE__*/
    React.createElement("tr", null, /*#__PURE__*/
    React.createElement("th", { className: "px-2 py-2 sm:px-4 sm:py-2" }, "\u4EE3\u865F"), /*#__PURE__*/
    React.createElement("th", { className: "px-2 py-2 sm:px-4 sm:py-2" }, "\u540D\u7A31"), /*#__PURE__*/
    React.createElement("th", { className: "px-2 py-2 sm:px-4 sm:py-2" }, "\u914D\u606F\u9031\u671F"), /*#__PURE__*/
    React.createElement("th", { className: "px-2 py-2 sm:px-4 sm:py-2" }, "\u4ECA\u5E74\u914D\u606F"), /*#__PURE__*/
    React.createElement("th", { className: "px-2 py-2 sm:px-4 sm:py-2" }, "\u76F8\u8F03\u53BB\u5E74"), /*#__PURE__*/
    React.createElement("th", { className: "px-2 py-2 sm:px-4 sm:py-2" }, "\u5E74\u5316\u6B96\u5229\u7387"), /*#__PURE__*/
    React.createElement("th", { className: "px-2 py-2 sm:px-4 sm:py-2" }, "\u985E\u5225"))), /*#__PURE__*/


    React.createElement("tbody", null,
    filteredETFs.map((etf) => /*#__PURE__*/
    React.createElement("tr", { key: etf.code, className: "border-b" }, /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-2" }, etf.code), /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-2" }, etf.name), /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-2" }, etf.period), /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-2" }, etf.dividend), /*#__PURE__*/
    React.createElement("td", { className: `px-2 py-2 sm:px-4 sm:py-2 ${getComparedColor(etf.compared)}` }, etf.compared), /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-2" }, etf.yield), /*#__PURE__*/
    React.createElement("td", { className: "px-2 py-2 sm:px-4 sm:py-2" }, etf.category))))))));
